...
namespace UI_Lib
{
    public class JLNumEdit01 : Panel
    {
        ...
        public int Value
        {
            ...
            set { m_intValue = value; m_TxtValue.Text = String.Format("{0:000}", m_intValue); }
        }
        ...
        public JLNumEdit01() : base()
        {
            Size = new Size(52, 26);//設定元件大小 50,26
            //m_intValue = m_intMinValue;

            m_TxtValue = new TextBox();
            m_TxtValue.Size = new Size(40, 26);
            ...
            m_TxtValue.Text = String.Format("{0:000}", m_intValue); //"" + m_intValue;
            ...
            m_butUp.Location = new Point(40, 0);
            ...
            m_butDown.Location = new Point(40, 13);
        ...
        {
            m_TxtValue.Text = String.Format("{0:000}", m_intValue);//修改期間不用應補成兩位數 at 2017/10/17
        }
        ...
        private void txt_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                m_TxtValue.Text = String.Format("{0:000}", m_intMaxValue); //"" + m_intMaxValue;
                m_intValue = m_intMaxValue;
            }
            else
            {
                m_TxtValue.Text = String.Format("{0:000}", m_intMinValue); //""" + m_intMinValue;
                m_intValue = m_intMinValue;
            }
        }
        ...
        private void Up_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    m_TxtValue.Text = String.Format("{0:000}", m_intMinValue);//"" + m_intMinValue;//產生循環
        ...
        private void Down_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    m_TxtValue.Text = String.Format("{0:000}", m_intMaxValue); //"" + m_intMaxValue;//產生循環
