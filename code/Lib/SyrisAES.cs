...
namespace SetCPUCardParameter
{
    ...
    byte[] inputByteArray00 = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x01, 0x12, 0x34, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x08, 0x0A, 0xBF, 0x00, 0x00, 0x00, 0x01, 0x06, 0x2E, 0x3C, 0xC8, 0xF0, 0x4C, 0xBA, 0x32, 0x92 };
    byte[] inputByteArray01 = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
    byte[] inputByteArray02 = { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
    Array.Reverse(inputByteArray02);
    byte[] _key1 = { 0x2E, 0x3C, 0xC8, 0xF0, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x12, 0x34, 0x56, 0x78 };
    Array.Reverse(_key1);
    SyrisAES a = new SyrisAES(keysize);
    byte[] outputByteArray = new byte[32];
    a.AES(inputByteArray02, outputByteArray);
    byte[] outputByteArray1 = new byte[32];
    a.UnAES(outputByteArray, outputByteArray1);
    //*/
    //---AES test
    ...
    {
        static public byte[] AESKey = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10 };//Syris 預設值
